...
pub const TASK_SESSION_REL_DIR_NAME = "tasks";
pub const CORPUS_INGEST_REL_DIR_NAME = "corpus_ingest";
pub const CORPUS_INGEST_STAGED_DIR_NAME = "staged";
pub const CORPUS_INGEST_LIVE_DIR_NAME = "live";
pub const CORPUS_INGEST_FILES_DIR_NAME = "files";
pub const CORPUS_INGEST_MANIFEST_FILE_NAME = "manifest.json";
pub const CORPUS_INGEST_SLOT_DIR_NAME = "corpus_ingest";
