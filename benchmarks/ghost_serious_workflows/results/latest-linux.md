...
- passed cases: 42
- failed cases: 0
- total benchmark wall time: 139066 ms
...
- latency per verified result: 7477 ms
- cold start / warm start: 268 ms / 326 ms
...
- measured repo scan / cache refresh / index materialize: 845 / 4096 / 510 ms
- measured support-aware routing index build: 175 ms; considered / selected / skipped / suppressed / cap_hits: 12 / 12 / 0 / 0 / 0
...
- measured pack mount resolve / manifest preview load / pack routing / pack catalog load: 1387 / 1137 / 246 / 1747 ms
...
- measured support graph build: 167 ms
...
- measured artifact schema pipeline / verifier adapter dispatch: 7 / 15 ms
- measured artifact json render / persist / panic capture: 0 / 0 / 0 ms
- measured verification workspace / build / test / runtime: 4171 / 70580 / 11879 / 6487 ms
- measured task artifact writes: 5 ms across 30 writes
- measured task session saves: 18 ms across 25 saves
- verifier candidate execution: 0 eligible, 0 scheduled, 0 completed, 0 failed, 0 blocked, 0 budget-hit
- correction events: 0; negative knowledge candidates: 0
- negative knowledge lifecycle: accepted=0, rejected=0, influence_matches=0, triage_penalties=0, verifier_requirements=0, trust_decay_candidates=0
...
- small vs large pack manifest preview / routing / catalog load delta: 144 / 34 / 238 ms
...
- tier comparison:
  ...
  high -> peak_activated=3, peak_candidate_surfaces=5, cap_hits=0, routing_ms=51
  max -> peak_activated=3, peak_candidate_surfaces=5, cap_hits=0, routing_ms=66
...
- `cold_warm_code_intel_start`: pass; expected `supported_success` got `supported_success`; tier=medium; pack_caps=0; local_truth=0; partials=0; ambiguities=0; suppressed_noise=0; reuse_hits=0; proof_blocks=0; cold=268ms warm=326ms cold_changed=15 warm_changed=0
