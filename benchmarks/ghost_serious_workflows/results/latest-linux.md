...
- passed cases: 42
- failed cases: 0
- total benchmark wall time: 160634 ms
...
- latency per verified result: 7486 ms
- cold start / warm start: 268 ms / 334 ms
...
- measured repo scan / cache refresh / index materialize: 850 / 4059 / 503 ms
- measured support-aware routing index build: 172 ms; considered / selected / skipped / suppressed / cap_hits: 12 / 12 / 0 / 0 / 0
...
- measured pack mount resolve / manifest preview load / pack routing / pack catalog load: 1382 / 1132 / 244 / 1734 ms
...
- measured support graph build: 159 ms
...
- measured artifact schema pipeline / verifier adapter dispatch: 8 / 19 ms
- measured artifact json render / persist / panic capture: 0 / 0 / 0 ms
- measured verification workspace / build / test / runtime: 4252 / 69949 / 11591 / 6440 ms
- measured task artifact writes: 10 ms across 30 writes
- measured task session saves: 21 ms across 25 saves
...
- small vs large pack manifest preview / routing / catalog load delta: 152 / 32 / 243 ms
- small vs large pack peak candidate surfaces / peak activated / skipped delta: 3 / 2 / -4
- tier comparison:
  low -> peak_activated=1, peak_candidate_surfaces=2, cap_hits=4, routing_ms=30
  high -> peak_activated=3, peak_candidate_surfaces=5, cap_hits=0, routing_ms=50
  max -> peak_activated=3, peak_candidate_surfaces=5, cap_hits=0, routing_ms=62
...
- `cold_warm_code_intel_start`: pass; expected `supported_success` got `supported_success`; tier=medium; pack_caps=0; local_truth=0; partials=0; ambiguities=0; suppressed_noise=0; reuse_hits=0; proof_blocks=0; cold=268ms warm=334ms cold_changed=15 warm_changed=0
