...
- passed cases: 42
- failed cases: 0
- total benchmark wall time: 143891 ms
...
- measured repo scan / cache refresh / index materialize: 853 / 4099 / 505 ms
- measured support-aware routing index build: 176 ms; considered / selected / skipped / suppressed / cap_hits: 12 / 12 / 0 / 0 / 0
...
- measured pack mount resolve / manifest preview load / pack routing / pack catalog load: 1385 / 1133 / 250 / 1739 ms
...
- measured verification workspace / build / test / runtime: 4110 / 70577 / 11916 / 6506 ms
- measured task artifact writes: 13 ms across 30 writes
- measured task session saves: 20 ms across 25 saves
...
- small vs large pack manifest preview / routing / catalog load delta: 148 / 37 / 243 ms
...
- tier comparison:
  ...
  high -> peak_activated=3, peak_candidate_surfaces=5, cap_hits=0, routing_ms=47
  max -> peak_activated=3, peak_candidate_surfaces=5, cap_hits=0, routing_ms=67
...
- `cold_warm_code_intel_start`: pass; expected `supported_success` got `supported_success`; tier=medium; pack_caps=0; local_truth=0; partials=0; ambiguities=0; suppressed_noise=0; reuse_hits=0; proof_blocks=0; cold=267ms warm=335ms cold_changed=15 warm_changed=0
