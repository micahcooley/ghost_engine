...
- passed cases: 42
- failed cases: 0
- total benchmark wall time: 133013 ms
...
- latency per verified result: 7120 ms
- cold start / warm start: 261 ms / 329 ms
...
- measured repo scan / cache refresh / index materialize: 829 / 3987 / 499 ms
...
- measured pack mount resolve / manifest preview load / pack routing / pack catalog load: 1372 / 1112 / 258 / 1715 ms
...
- measured verification workspace / build / test / runtime: 4047 / 67123 / 11182 / 6164 ms
...
- small vs large pack manifest preview / routing / catalog load delta: 150 / 33 / 243 ms
...
- `cold_warm_code_intel_start`: pass; expected `supported_success` got `supported_success`; tier=medium; pack_caps=0; local_truth=0; partials=0; ambiguities=0; suppressed_noise=0; reuse_hits=0; proof_blocks=0; cold=261ms warm=329ms cold_changed=15 warm_changed=0
