...
- passed cases: 42
- failed cases: 0
- total benchmark wall time: 138585 ms
...
- latency per verified result: 7439 ms
- cold start / warm start: 265 ms / 332 ms
...
- measured repo scan / cache refresh / index materialize: 837 / 4118 / 503 ms
...
- measured pack mount resolve / manifest preview load / pack routing / pack catalog load: 1370 / 1123 / 246 / 1727 ms
...
- measured support graph build: 158 ms
...
- measured artifact schema pipeline / verifier adapter dispatch: 8 / 11 ms
- measured artifact json render / persist / panic capture: 0 / 0 / 0 ms
- measured verification workspace / build / test / runtime: 4088 / 70069 / 12047 / 6478 ms
...
- small vs large pack manifest preview / routing / catalog load delta: 147 / 34 / 246 ms
- small vs large pack peak candidate surfaces / peak activated / skipped delta: 3 / 2 / -4
- tier comparison:
  low -> peak_activated=1, peak_candidate_surfaces=2, cap_hits=4, routing_ms=27
  high -> peak_activated=3, peak_candidate_surfaces=5, cap_hits=0, routing_ms=49
  max -> peak_activated=3, peak_candidate_surfaces=5, cap_hits=0, routing_ms=65
...
- `cold_warm_code_intel_start`: pass; expected `supported_success` got `supported_success`; tier=medium; pack_caps=0; local_truth=0; partials=0; ambiguities=0; suppressed_noise=0; reuse_hits=0; proof_blocks=0; cold=265ms warm=332ms cold_changed=15 warm_changed=0
