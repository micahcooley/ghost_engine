...
- passed cases: 42
- failed cases: 0
- total benchmark wall time: 132854 ms
...
- latency per verified result: 7135 ms
- cold start / warm start: 259 ms / 323 ms
...
- measured repo scan / cache refresh / index materialize: 812 / 3929 / 488 ms
- measured support-aware routing index build: 165 ms; considered / selected / skipped / suppressed / cap_hits: 12 / 12 / 0 / 0 / 0
...
- measured pack mount resolve / manifest preview load / pack routing / pack catalog load: 1338 / 1091 / 243 / 1682 ms
...
- measured support graph build: 160 ms
...
- measured verification workspace / build / test / runtime: 4053 / 67237 / 11245 / 6182 ms
- measured task artifact writes: 4 ms across 30 writes
- measured task session saves: 15 ms across 25 saves
...
- small vs large pack manifest preview / routing / catalog load delta: 144 / 33 / 237 ms
...
- tier comparison:
  ...
  high -> peak_activated=3, peak_candidate_surfaces=5, cap_hits=0, routing_ms=48
...
- `cold_warm_code_intel_start`: pass; expected `supported_success` got `supported_success`; tier=medium; pack_caps=0; local_truth=0; partials=0; ambiguities=0; suppressed_noise=0; reuse_hits=0; proof_blocks=0; cold=259ms warm=323ms cold_changed=15 warm_changed=0
